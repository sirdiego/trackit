...
class Moment
{
	...
	public static function findByIdentifier($identifier, \PDO $database)
	{
	...
	public static function findByParent($identifier, \PDO $database)
	{
	...
	public static function persist(Moment $moment, \PDO $database)
	{
		if ($moment->new) {
